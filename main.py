...
def segue_linha():
    ...
    if (valor_meio < branco_meio): #sensor do meio vendo preto
        ...
        if valor_dir > preto and valor_esq > preto: #somente o do meio vendo preto
            ...
            if valor_esq < verde_esq:
                Sound().beep()
                motores.on_for_seconds(SpeedPercent(-10), SpeedPercent(-35), 1)#giro 90°
            ...
            if valor_dir < verde:
                Sound().beep()
                motores.on_for_seconds(SpeedPercent(-35), SpeedPercent(-10), 1)#giro 90°
...
objetivo_meio = 470 #450 às 14hrs e 16:30 // 500 às 16hrs // 300 às 18hrs
verde_meio = 400
